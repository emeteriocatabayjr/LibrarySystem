...
include ('includes/connection.php');
		...
		$query = "
			SELECT booktitle, bookcover, category, author, publishername, dateborrowed, transactionID, datereturned
				  		...
				  		<div class="d-inline-flex p-3 mx-auto">
				  			<div class="card mx-auto text" style="width:20rem; height:40rem;">
		  						<div class="card-header">
		  							...
		  							<span class="float-right badge badge-success">Borrowed</span>
		  						</div>
								<div class="card-body">
